...
def proc_tc_data(tc_name):
    url = 'http://www.typhoon2000.ph/multi/data/' + tc_name + '.TXT'
    ...
    if (r.status_code == 200):
        ...
        out_df = pd.DataFrame(columns=['Center', 'Date', 'Lat', 'Lon', 'Vmax'])
        ...
        return out_df[['Center', 'Date', 'Lat', 'Lon', 'Vmax']]
    return None
